...
public abstract class V1_20_4_FancyMessageAdapter extends V1_20_4_BiomeTPAdapter {
    ...
    public NBTTagCompound getNBTTag(net.minecraft.world.item.ItemStack nmsStack) {
        return nmsStack.w(); //not Nullable
    }
    ...
    public void put(NBTTagCompound tag, String name, NBTBase tagData) {
        tag.a(name, tagData);
    }
