...
public class Delay extends SubCommand {
    ...
    public Delay() {
        ...
        emptyPermissionState.setCommandDescription(textComponent("This command is used to set if the delay is managed by permissions or by TPort self, if ", ColorType.infoColor),
                ...
                textComponent("\n\nPermissions: ", ColorTheme.ColorType.infoColor), textComponent("TPort.delay.permission.set", ColorTheme.ColorType.varInfoColor),
                textComponent(" or ", ColorTheme.ColorType.infoColor), textComponent("TPort.admin.delay", ColorTheme.ColorType.varInfoColor));
        emptyPermissionState.setRunnable(((args, player) -> {
            if (args.length == 2) {
                if (hasPermission(player, true, true, "TPort.delay.permission.get", "TPort.admin.delay")) {
                ...
                if (hasPermission(player, true, true, "TPort.delay.permission.set", "TPort.admin.delay")) {
                    Files tportConfig = getFile("TPortConfig");
        ...
        emptyPermission.setCommandDescription(textComponent("This command is used to get if the delay is managed by permissions or by TPort self", ColorType.infoColor),
                textComponent("\n\nPermissions: ", ColorTheme.ColorType.infoColor), textComponent("TPort.delay.permission.get", ColorTheme.ColorType.varInfoColor),
                textComponent(" or ", ColorTheme.ColorType.infoColor), textComponent("TPort.admin.delay", ColorTheme.ColorType.varInfoColor));
        ...
        emptySetPlayerDelay.setCommandDescription(textComponent("This command is used to set the delay of the given player, " +
                ...
                textComponent("/tport delay permission [state]", ColorType.varInfoColor),
                textComponent(" to change this", ColorType.infoColor),
                textComponent("\n\nPermissions: ", ColorTheme.ColorType.infoColor), textComponent("TPort.delay.set", ColorTheme.ColorType.varInfoColor),
                textComponent(" or ", ColorTheme.ColorType.infoColor), textComponent("TPort.admin.delay", ColorTheme.ColorType.varInfoColor));
        emptySetPlayerDelay.setRunnable(((args, player) -> {
            if (args.length == 4) {
                if (hasPermission(player, true, true, "TPort.delay.set", "TPort.admin.delay")) {
                    Files tportConfig = getFile("TPortConfig");
                    if (!tportConfig.getConfig().getBoolean("delay.permission", false)) {
                        try {
                            ...
                            tportConfig.saveConfig();
                            sendSuccessTheme(player, "Successfully set the delay time for player %s to %s", args[2], String.valueOf(delay));
        ...
        emptySetPlayer.setRunnable((emptySetPlayerDelay::run));
        ...
        emptySet.setRunnable(emptySetPlayerDelay::run);
        ...
        emptyGetPlayer.setCommandDescription(textComponent("This command is used to get the delay of the given player", ColorType.infoColor),
                textComponent("\n\nPermissions: ", ColorTheme.ColorType.infoColor), textComponent("TPort.delay.get.all", ColorTheme.ColorType.varInfoColor),
                textComponent(" or ", ColorTheme.ColorType.infoColor), textComponent("TPort.admin.delay", ColorTheme.ColorType.varInfoColor));
        emptyGetPlayer.setRunnable(((args, player) -> {
            if (args.length == 2) {
                if (hasPermission(player, true, "TPort.delay.get.own"))
                    sendInfoTheme(player, "Your delay time is %s (in minecraft ticks)", String.valueOf(delayTime(player)));
            } else if (args.length == 3) {
                if (hasPermission(player, true, true, "TPort.delay.get.all", "TPort.admin.delay")) {
        ...
        emptyGet.setCommandDescription(textComponent("This command is used to get your delay", ColorType.infoColor),
                textComponent("\n\nPermission: ", ColorTheme.ColorType.infoColor), textComponent("TPort.delay.get.own", ColorTheme.ColorType.varInfoColor));
